...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  // 邀请统计
  inviteStats: {
    listActivityTags: () => ipcRenderer.invoke('inviteStats:listActivityTags'),
    saveActivityTag: (payload: { tagId?: string; tagName: string; enabled?: boolean }) =>
      ipcRenderer.invoke('inviteStats:saveActivityTag', payload),
    setActivityTagEnabled: (tagId: string, enabled: boolean) =>
      ipcRenderer.invoke('inviteStats:setActivityTagEnabled', tagId, enabled),
    deleteActivityTag: (tagId: string) => ipcRenderer.invoke('inviteStats:deleteActivityTag', tagId),
    ...
    rescanActivity: (tagId: string) => ipcRenderer.invoke('inviteStats:rescanActivity', tagId),
